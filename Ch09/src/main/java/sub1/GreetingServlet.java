...
public class GreetingServlet extends HttpServlet{
	private static final long serialVersionUID = -8171384268828728367L;
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		System.out.println("===============================");
		System.out.println("Greeting Servlet get() 전송");
		...
		writer.print("<title>Greeting Servlet</title>");
		writer.print("</head>");
		writer.print("<body>");
		...
		writer.print("<br/>");
		writer.print("<a href='./greeting.do'>Greeting servlet</a>");
		writer.print("</body>");
		writer.print("</html>");
		writer.close();
	}
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		System.out.println("===============================");
		System.out.println("Greeting Servlet post() 전송");
	}
